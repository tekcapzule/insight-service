...
@Component
@Slf4j
public class GetAllIndexRecordsFunction implements Function<Message<EmptyFunctionInput>, Message<List<Insights>>> {

    private final InsightService insightService;

    private final AppConfig appConfig;

    public GetAllIndexRecordsFunction(final InsightService insightService, final AppConfig appConfig) {
