...
import com.tekcapsule.insights.application.function.input.GetNewsInput;
...
@Component
@Slf4j
public class GetStocksFunction implements Function<Message<GetNewsInput>, Message<List<Insights>>> {

    private final InsightService insightService;

    private final AppConfig appConfig;

    public GetStocksFunction(final InsightService insightService, final AppConfig appConfig) {
