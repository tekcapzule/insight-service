...
@Component
@Slf4j
public class GetFunction implements Function<Message<GetNewsInput>, Message<List<Insights>>> {

    private final InsightService insightService;

    private final AppConfig appConfig;

    public GetFunction(final InsightService insightService, final AppConfig appConfig) {
