...
@Component
@Slf4j
public class GetNewsFunction implements Function<Message<GetNewsInput>, Message<List<Insights>>> {

    private final InsightService insightService;

    private final AppConfig appConfig;

    public GetNewsFunction(final InsightService insightService, final AppConfig appConfig) {
